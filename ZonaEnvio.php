...
class ZonaEnvio
{
    ...
    { // or initialize it with a meaningful value
    }
    ...
    public function determinarZonaEnvioSeur($destinoCP)
    {
        

        // Prefijos de códigos postales de las provincias de Andalucía
        $prefijosCorto = ['04', '06', '64', '75', '11', '14', '18', '21', '23', '29', '41'];
        $prefijosMedio = ['49', '47', '40', '80', '19', '16', '02', '30', '78', '13', '45', '28', '05', '10', '59', '37'];
        $prefijosLargo = ['58', '15', '71', '72', '32', '27', '68', '33', '24', '34', '39', '9', '48', '1', '26', '42', '20', '31', '50', '44', '46', '3', '12', '43', '22', '25', '77', '17', '95', '54', '53', '91', '93', '8', '89', '94'];
        // Verifica que el código postal tenga 5 dígitos numéricos
        if (!preg_match('/^\d{5}$/', $destinoCP)) {
            return 'Código postal inválido, si tu codigo postal es de menos de 5 digitos, por favor añade un 0 al principio';
        }

        // Extrae los dos primeros dígitos del código postal de destino
        $prefijoDestino = substr($destinoCP, 0, 2);

        // Determina el tipo de envío
        if (in_array($prefijoDestino, $prefijosCorto)) {
            return 'Corto';
        } elseif (in_array($prefijoDestino, $prefijosMedio)) {
            return 'Medio';
        } elseif (in_array($prefijoDestino, $prefijosLargo)) {
            return 'Largo';
